...
def main():
    train_dataset = BrainSliceDataset(DATA_PATH, split='train', image_size=(IMAGE_SIZE, IMAGE_SIZE), ct_max=CT_MAX, pet_max=PET_MAX, flip=True)
    ...
    wandb_logger = WandbLogger(project="CT2PET_Segmentation", name=model_name)
